...
import styles from "./EtapaTwo.module.css";
import WindowSize from "../WindowSize";
//import PropTypes from "prop-types";
export default function EtapaTwo({ ...props }) {
  ...
  return (
    ...
    >
      <div className={styles.container_etapa_type}>
        <h2>
          <i className="ri-signpost-line"></i> 0{props.numero}|03
        </h2>
        <div className={styles.modal_formas_pagamentos_acomp}>
          <div className={styles.box_pagamento_acomp}>
            <input
              type="checkbox"
        ...
        <div className={styles.modal_zap_price_acomp}>
          <input
            type="text"
            required
        ...
        <div className={styles.modal_acomp_gen_etnia_body}>
          <div className={styles.modal_genero_acomp}>
            <select
              defaultValue="Genero"
              name=""
              id=""
          ...
          <div className={styles.modal_etnia_acomp}>
            <select
              name=""
              value={etniaValue}
          ...
          <div className={styles.modal_corpo_acomp}>
            <select
              name=""
              value={bodyValue}
        ...
        <div className={styles.modal_altura_peso_acomp}>
          ...
          <div className={styles.modal_peso_acomp}>
