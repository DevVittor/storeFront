    ...
    return (
        <div className="card_profile">
            <div className="avatar_profile">
                <img src={props.avatar || "https://images.pexels.com/photos/6779485/pexels-photo-6779485.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"} alt="foto" />
            ...
            <div className="name_profile">
                <h2>{props.nome || "Nome"} {props.sobrenome || "Sobrenome"}, {props.idade || "idade"}</h2>
                <span>{props.estado || "Estado"}, {props.cidade || "cidade"}</span>
            </div>
        </div>
    )
}
