                ...
                <div className='service_filter_acomp'>
                    {service.map((item,index)=>(
                        <div key={index} className="check_filter_service">
                            ...
                            <label htmlFor={`check_filter_${index}`}>
                                {item}
                            </label>
                        </div>
                    ))}
